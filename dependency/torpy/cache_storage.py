...
from dependency.torpy.utils import user_data_dir
from dependency.torpy.documents import TorDocument
...
class TorCacheDirStorage(TorCacheStorage):
    def __init__(self, base_dir=None):
        self._base_dir = base_dir or user_data_dir('dependency.torpy')
