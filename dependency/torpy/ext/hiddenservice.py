...
from dependency.torpy.ext.cells import CellRelayRendezvous2
from dependency.torpy.ext.utils import AuthType
from dependency.torpy.ext.parsers import IntroPointParser, HSDescriptorParser
from dependency.torpy.ext.crypto_common import sha1, aes_update, aes_ctr_decryptor, b64decode, curve25519_public_from_bytes

if TYPE_CHECKING:
    from dependency.torpy.ext.circuit import TorCircuit
...
class ResponsibleDir:
    ...
    def _get_intro_points(self, response, descriptor_cookie):
        ...
        for intro_point_info in intro_points_info_list:
            yield self._info_to_router(intro_point_info)
...
class IntroductionPoint:
    ...
    def connect(self, hidden_service=None, rendezvous_cookie=None, expected=None, callback=None):
        ...
        with self._circuit.create_waiter(CellRelayRendezvous2) as w:
            ...
            with self._circuit.create_new_circuit(extend_routers=[self._introduction_router]) as intro_circuit:
                ...
                # Send Introduce1
                return callback(w, intro_circuit)
