...
from dependency.torpy.ext.guard import TorGuard
from dependency.torpy.ext.utils import retry, log_retry
from dependency.torpy.ext.circuit import TorCircuit
from dependency.torpy.ext.cell_socket import TorSocketConnectError
from dependency.torpy.ext.consesus import TorConsensus
from dependency.torpy.ext.cache_storage import TorCacheDirStorage
...
class TorClient:
    def __init__(self, consensus=None, auth_data=None, use_local_directories=True):
        self._consensus = consensus or TorConsensus(use_local_directories=use_local_directories)
